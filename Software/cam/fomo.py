...
cam = csi.CSI()
cam.reset()  # Reset and initialize the sensor.
cam.pixformat(csi.RGB565)  # Set pixel format to RGB565 (or GRAYSCALE)
cam.framesize(csi.QVGA)  # Set frame size to QVGA (320x240)
cam.window((240, 240))  # Set 240x240 window.
cam.snapshot(time=2000)  # Let the camera adjust.
